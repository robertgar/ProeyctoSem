...
<div class="content">
 <br><br>
  ...
  <div class="panel panel-success">
    ...
    <tbody>
      <?php
      $sql = "SELECT s.id_sol AS sid,p.dpi_pa AS dpi_pa, p.nom_pa AS nom_pa,s.fecha_c AS fecha
FROM tbl_serv as t 
...
if ($result_sol > 0) {
  ...
  while($row =  mysqli_fetch_array($query_so)) {
    ...
    ?>
           ...
           <td><a href="reportes/repmedi.php?id=<?php echo $row["sid"];?>" class="btn btn-info btn-lg" target="_blank">
