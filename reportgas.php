...
<div class="content">
 <br><br>
  ...
  <div class="panel panel-success">
    ...
    <tbody>
      <?php
      $sql = "SELECT SUM(monto) AS total,`mes` FROM `detalle_gasto` GROUP BY `mes`";
  ...
  while($row =  mysqli_fetch_array($query_so)) {
    ?>
           ...
           <td><?php echo $row["total"];?></td>
            <td>
              <a href="reportes/repgat.php?id=<?php echo $row["mes"];?>" class="btn btn-info btn-lg" target="_blank">
